...
<jsp:include page="includes/header.jsp">
    <jsp:param name="pageActive" value="admin/events" />
...
<%
    Events request_info = (Events) session.getAttribute("event");
...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <%
                    List<Employee> employees_from_event = (List<Employee>) session.getAttribute("employees_from_event");
                %>

                <ul class="list-group list-group-flush">
                    <li class="list-group-item"><div class="row">
                        <div class="col-lg-3 font-weight-bold text-center">Name</div>
                        <div class="col-lg-3 font-weight-bold text-center">Type</div>
                        <div class="col-lg-3 font-weight-bold text-center">Phone</div>
                        <div class="col-lg-3 font-weight-bold text-center">Delete</div>
                    </div></li>
                    <%for (Employee employee : employees_from_event){%>
                    <li class="list-group-item"><div class="row">
                        <div class="col-lg-3 font-weight-bold text-center"><%=employee.getName()%></div>
                        <div class="col-lg-3 text-center"><%=employee.getEmployee_type().getName()%></div>
                        <div class="col-lg-3 text-center"><%=employee.getPhone_number()%></div>
                        <div class="col-lg-3 text-center">
                            <form action="/admin/deleteEventsEmployee" method="post">
                                <input type="text" class="d-none" name="event_id" value="<%=request_info.getId()%>" readonly/>
                                <input type="text" class="d-none" name="employee_id" value="<%=employee.getId()%>" readonly/>
                                <button type="submit" class="btn btn-link"><i class="fas fa-trash-alt btn text-danger p-0"></i></button>
                            </form>
                            </div>
                    </div></li>
    ...
    <div class="col-lg-12">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Add employee for event</h6>
            </div>
            <div class="card-body">
