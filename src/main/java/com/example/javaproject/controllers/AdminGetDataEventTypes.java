...
@WebServlet(
        name = "getDataEventType",
        value = "/admin/getDataEventType")

public class AdminGetDataEventTypes extends HttpServlet {
    ...
    protected void doPost(
        ...
        mapper.writeValue(response.getWriter(), EventsService.getEventTypeById(id));
