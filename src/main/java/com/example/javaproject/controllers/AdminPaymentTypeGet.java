...
@WebServlet(
        name = "getDataPaymentType",
        value = "/admin/getDataPaymentType")
public class AdminPaymentTypeGet extends HttpServlet {
    ...
    protected void doPost(
        ...
        mapper.writeValue(response.getWriter(), Fee_scheduleService.getPaymentTypeById(id));
