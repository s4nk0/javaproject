...
<jsp:include page="includes/header.jsp">
    <jsp:param name="pageActive" value="/about" />
</jsp:include>
<%
    List<Employee> employees = (List<Employee>) session.getAttribute("most_popular_employee");
%>
...
<section class="about-section spad">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="about-pic">
                    <img src="main/img/about-us.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="testimonial-slider owl-carousel">
                        <div class="col-lg-6">
                            <div class="testimonial-item">
                                <div class="ti-author">
                                    <div class="quote-pic">
                                        <img src="main/img/quote.png" alt="">
                                    </div>
                                    <div class="ta-pic">
                                        <img src="main/img/testimonial/testimonial-1.jpg" alt="">
                                    </div>
                                    <div class="ta-text">
                                        <h5>Emma Sandoval</h5>
                        ...
                        <div class="col-lg-6">
                            <div class="testimonial-item">
                                <div class="ti-author">
                                    ...
                                    <div class="ta-pic">
                                        <img src="main/img/testimonial/testimonial-2.jpg" alt="">
                                    </div>
                                    <div class="ta-text">
                                        <h5>John Smith</h5>
                                        <span>Speaker Manager</span>
